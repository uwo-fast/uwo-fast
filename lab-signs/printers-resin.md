...
- Avoid skin and eye contact with uncured resin.
- Keep bottles, vats, and wash containers closed when not actively in use.
- Keep contaminated gloves, wipes, tools, and parts away from clean surfaces.
- Clean minor drips only if you have been trained on the approved resin cleanup process.
- Stop and ask if there is a spill, leak, damaged vat, unusual odor, or printer fault.
...
- Return resin bottles, tools, and PPE supplies to their proper places.
- Leave the printer, wash/cure station, and surrounding bench clean.
- Label or remove your parts so the next user knows what is safe to handle.
- Report low supplies, damage, spills, or printer problems.
...
- Formlabs resin disposal support: <https://support.formlabs.com/s/article/Disposing-of-resin>
- Formlabs IPA support: <https://support.formlabs.com/s/article/Isopropyl-Alcohol-IPA>
